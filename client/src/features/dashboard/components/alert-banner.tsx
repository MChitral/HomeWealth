      ...
      <AlertDescription className={!isCritical ? "text-yellow-700" : ""}>
        <div className="space-y-4">
          <div>
            {isCritical ? (
              <span>
                <b>Critical Action Required:</b> Your mortgage rate ({currentRatePct}%) has exceeded your trigger rate of{" "}
              ...
              <span>
                ...
                <b>{triggerRatePct}%</b>. Your current rate is <b>{currentRatePct}%</b>. Consider increasing your payments now to build a buffer.
              </span>
            )}
          </div>
                ...
                <div className="space-y-3">
                  ...
                  {requiredPayment !== undefined && (
                    <div className="flex justify-between items-center pt-2 border-t">
                      <span className="text-sm font-medium">Required Payment to Prevent Increase:</span>
