...
export function ProjectionsHeader({
  ...
  return (
    <section className="flex flex-wrap items-center justify-between gap-4">
      <div>
        <h2 className="text-2xl font-semibold" data-testid="text-forecasting-heading">Scenario Forecast</h2>
        <p className="text-sm text-muted-foreground">
          {selectedHorizon}-year projection based on selected scenario
        </p>
      </div>
